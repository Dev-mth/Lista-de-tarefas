<template>
    <div class="bg-gray-300 rounded-sm">
        <div class="flex items-center px-4 py-3 border-b border-gray-400last:border-b-0">
...
<script>
    export default {
        ...
        methods: {
            ...
            /*Quando o título for alterado / checagem -> updateTodo*/
            onTitleChange() {
                if (!this.title) {
                    return
                }
            ...
            /*Quando o check for clicado / checagem -> updateTodo*/
            onCheckClick() {
